" Vim syntax file
" Language:	Lang
" Maintainer:	Ryan Munro <x05x39@gmail.com>
...
"
syn keyword pythonStatement	false true undefined null Infinity NaN
syn keyword pythonStatement	var new in return typeof instanceof delete
syn keyword pythonStatement	class gen def eval
syn keyword pythonConditional	if else
syn keyword pythonRepeat	for while
syn keyword pythonOperator	in
syn keyword pythonException	try catch finally
...
if !exists("python_no_builtin_highlight")
  ...
  syn keyword pythonBuiltin	false true undefined
  " built-in functions
  syn keyword pythonBuiltin	eval var
